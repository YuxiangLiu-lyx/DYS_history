# 当前第四回：v1.6 人物母版与文字动作

进入[当前导演入口](releases/huibenji/chapter04_v1/START_HERE.md)。五图投料，吻和相拥亲吻拉远由Prompt生成，不再等待静态吻图；H01–H03及60秒音乐不变，唱者时码与实际视频仍待验收。下方为历史发布记录。

# 当前制作：第四回 v1.5 · 完整60秒音轨续接

H01/H02/H03用户已完成，全部冻结。本轮只做H04–H09：原定《卜卦》60秒完整使用，之后68秒放琴、长对视、缓近深吻和极慢拉远。新关键参考图均从C01/C05原母版重生。

**母带已收到；逐句唱者与口型边界尚未核听通过。** 两种ASR与同版视频波形核对不能代替真实声部核听，H04/H05正式演唱Prompt暂未签发；其余四段是可审导演稿。近吻参考图被图像服务安全审核以sexual类别拒绝，尚未生成；非接触替代图不冒充接吻完成。原音轨不剪短、不改曲式、不淡出或补尾奏。

[当前入口](releases/huibenji/chapter04_v1/START_HERE.md) · [音频核验范围](releases/huibenji/chapter04_v1/audio/BUGUA_SOURCE_REPORT.md) · [身份规则](releases/huibenji/chapter04_v1/PAN_HUI_IDENTITY_RULES.md) · [逐段材料](releases/huibenji/chapter04_v1/SCENE_FILES.md) · [AI续作规则](AGENTS.md)

以下各版本均为历史记录，旧时长、旧图和“曲源仍缺”不适用于本版。
