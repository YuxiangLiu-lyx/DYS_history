...
|首尾帧|严格first_frame/last_frame与全能多模态参考不可同次混用|本包选多模态参考，本版首末态为文字描述，不上传失真双人关键图，不承诺严格首尾|
...
当前投料组合：两张独立人物母版+潘单人笑意参考+巨松空景+完整阮，共5图，再加上一段真实短尾片；唱段仅加对应连续30秒歌曲切片。对视、吻与远景由动作Prompt引导，不要求静态接触关键图。各类素材显式写编号，构图帧不替换人物身份。官方建议参考主体聚焦，不能为了达到上限塞图。
